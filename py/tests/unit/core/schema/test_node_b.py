...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            (4, 9),
            ((3, 8), (3, 9), (4, 10), (5, 10), (5, 9), (4, 8)),
        ),  # for node index 40
        (
            (4, 10),
            ((3, 9), (3, 10), (4, 11), (5, 11), (5, 10), (4, 9)),
        ),  # for node index 41
        (
            (4, 11),
            ((3, 10), (3, 11), (4, 12), (5, 12), (5, 11), (4, 10)),
        ),  # for node index 42
        (
            (4, 12),
            ((3, 11), (3, 12), (4, 13), (5, 13), (5, 12), (4, 11)),
        ),  # for node index 43
        (
            (4, 13),
            ((3, 12), (3, 13), (4, 14), (5, 14), (5, 13), (4, 12)),
        ),  # for node index 44
        (
            (4, 14),
            ((3, 13), (3, 14), (4, 0), (5, 0), (5, 14), (4, 13)),
        ),  # for node index 45
        (
            (5, 0),
            ((4, 14), (4, 0), (5, 1), (6, 1), (6, 0), (5, 14)),
        ),  # for node index 46
        ...
        (
            (5, 9),
            ((4, 8), (4, 9), (5, 10), (6, 10), (6, 9), (5, 8)),
        ),  # for node index 55
        (
            (5, 10),
            ((4, 9), (4, 10), (5, 11), (6, 11), (6, 10), (5, 9)),
        ),  # for node index 56
        (
            (5, 11),
            ((4, 10), (4, 11), (5, 12), (6, 12), (6, 11), (5, 10)),
        ),  # for node index 57
        (
            (5, 12),
            ((4, 11), (4, 12), (5, 13), (6, 13), (6, 12), (5, 11)),
        ),  # for node index 58
        (
            (5, 13),
            ((4, 12), (4, 13), (5, 14), (6, 14), (6, 13), (5, 12)),
        ),  # for node index 59
        (
            (5, 14),
            ((4, 13), (4, 14), (5, 0), (6, 0), (6, 14), (5, 13)),
        ),  # for node index 60
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            (5, 14),
            ((4, 13), (4, 14), (5, 15), (6, 15), (6, 14), (5, 13)),
        ),  # for node index 65
        (
            (5, 15),
            ((4, 14), (4, 15), (5, 16), (6, 16), (6, 15), (5, 14)),
        ),  # for node index 66
        (
            (5, 16),
            ((4, 15), (4, 16), (5, 17), (6, 17), (6, 16), (5, 15)),
        ),  # for node index 67
        (
            (5, 17),
            ((4, 16), (4, 17), (5, 18), (6, 18), (6, 17), (5, 16)),
        ),  # for node index 68
        (
            (5, 18),
            ((4, 17), (4, 18), (5, 19), (6, 19), (6, 18), (5, 17)),
        ),  # for node index 69
        (
            (5, 19),
            ((4, 18), (4, 19), (5, 0), (6, 0), (6, 19), (5, 18)),
        ),  # node_index 70
        ...
        (
            (6, 9),
            ((5, 8), (5, 9), (6, 10), (7, 10), (7, 9), (6, 8)),
        ),  # for node index 80
        (
            (6, 10),
            ((5, 9), (5, 10), (6, 11), (7, 11), (7, 10), (6, 9)),
        ),  # for node index 81
        (
            (6, 11),
            ((5, 10), (5, 11), (6, 12), (7, 12), (7, 11), (6, 10)),
        ),  # for node index 82
        (
            (6, 12),
            ((5, 11), (5, 12), (6, 13), (7, 13), (7, 12), (6, 11)),
        ),  # for node index 83
        (
            (6, 13),
            ((5, 12), (5, 13), (6, 14), (7, 14), (7, 13), (6, 12)),
        ),  # for node index 84
        (
            (6, 14),
            ((5, 13), (5, 14), (6, 15), (7, 15), (7, 14), (6, 13)),
        ),  # for node index 85
        (
            (6, 15),
            ((5, 14), (5, 15), (6, 16), (7, 16), (7, 15), (6, 14)),
        ),  # for node index 86
        (
            (6, 16),
            ((5, 15), (5, 16), (6, 17), (7, 17), (7, 16), (6, 15)),
        ),  # for node index 87
        (
            (6, 17),
            ((5, 16), (5, 17), (6, 18), (7, 18), (7, 17), (6, 16)),
        ),  # for node index 88
        (
            (6, 18),
            ((5, 17), (5, 18), (6, 19), (7, 19), (7, 18), (6, 17)),
        ),  # for node index 89
        (
            (6, 19),
            ((5, 18), (5, 19), (6, 0), (7, 0), (7, 19), (6, 18)),
        ),  # node_index 90
        ...
        (
            (7, 9),
            ((6, 8), (6, 9), (7, 10), (8, 10), (8, 9), (7, 8)),
        ),  # for node index 100
        (
            (7, 10),
            ((6, 9), (6, 10), (7, 11), (8, 11), (8, 10), (7, 9)),
        ),  # for node index 101
        (
            (7, 11),
            ((6, 10), (6, 11), (7, 12), (8, 12), (8, 11), (7, 10)),
        ),  # for node index 102
        (
            (7, 12),
            ((6, 11), (6, 12), (7, 13), (8, 13), (8, 12), (7, 11)),
        ),  # for node index 103
        (
            (7, 13),
            ((6, 12), (6, 13), (7, 14), (8, 14), (8, 13), (7, 12)),
        ),  # for node index 104
        (
            (7, 14),
            ((6, 13), (6, 14), (7, 15), (8, 15), (8, 14), (7, 13)),
        ),  # for node index 105
        (
            (7, 15),
            ((6, 14), (6, 15), (7, 16), (8, 16), (8, 15), (7, 14)),
        ),  # for node index 106
        (
            (7, 16),
            ((6, 15), (6, 16), (7, 17), (8, 17), (8, 16), (7, 15)),
        ),  # for node index 107
        (
            (7, 17),
            ((6, 16), (6, 17), (7, 18), (8, 18), (8, 17), (7, 16)),
        ),  # for node index 108
        (
            (7, 18),
            ((6, 17), (6, 18), (7, 19), (8, 19), (8, 18), (7, 17)),
        ),  # for node index 109
        (
            (7, 19),
            ((6, 18), (6, 19), (7, 0), (8, 0), (8, 19), (7, 18)),
        ),  # node_index 110
    ],
)
