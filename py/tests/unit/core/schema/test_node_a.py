...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            (2, 6),
            ((1, 3), (2, 7), (3, 10), (3, 9), (3, 8), (2, 5)),
        ),  # for node index 12
        (
            (2, 7),
            ((1, 3), (1, 4), (2, 8), (3, 11), (3, 10), (2, 6)),
        ),  # for node index 13
        (
            (2, 8),
            ((1, 4), (2, 9), (3, 13), (3, 12), (3, 11), (2, 7)),
        ),  # for node index 14
        (
            (2, 9),
            ((1, 4), (1, 0), (2, 0), (3, 14), (3, 13), (2, 8)),
        ),  # for node index 15
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            (3, 7),
            ((2, 4), (2, 5), (3, 8), (4, 10), (4, 9), (3, 6)),
        ),  # for node index 23
        (
            (3, 8),
            ((2, 5), (2, 6), (3, 9), (4, 11), (4, 10), (3, 7)),
        ),  # for node index 24
        (
            (3, 9),
            ((2, 6), (3, 10), (4, 13), (4, 12), (4, 11), (3, 8)),
        ),  # for node index 25
        (
            (3, 10),
            ((2, 6), (2, 7), (3, 11), (4, 14), (4, 13), (3, 9)),
        ),  # for node index 26
        (
            (3, 11),
            ((2, 7), (2, 8), (3, 12), (4, 15), (4, 14), (3, 10)),
        ),  # for node index 27
        (
            (3, 12),
            ((2, 8), (3, 13), (4, 17), (4, 16), (4, 15), (3, 11)),
        ),  # for node index 28
        (
            (3, 13),
            ((2, 8), (2, 9), (3, 14), (4, 18), (4, 17), (3, 12)),
        ),  # for node index 29
        (
            (3, 14),
            ((2, 9), (2, 0), (3, 0), (4, 19), (4, 18), (3, 13)),
        ),  # for node index 30
    ],
)
