...
class Constants:
    ...
    def __init__(self, partition: int = 1):
        ...
        self.area_a.nodes.NUMBER = (
            self.PARTITION_SQUARE_TIMES_FIVE - self.PARTITION_TIMES_FIVE
        ) // 2
        ...
        self.area_b.nodes.START = (
            self.border_ab.nodes.START + self.border_ab.nodes.NUMBER
        )
        self.border_ab.nodes.END = self.area_b.nodes.START - 1
        self.area_b.nodes.NUMBER = (
            self.PARTITION_MINUS_ONE * self.border_ab.nodes.NUMBER
        )
        ...
        self.area_c.nodes.START = (
            self.border_bc.nodes.START + self.border_bc.nodes.NUMBER
        )
        ...
        self.border_ab.node_layer.INDEX = (
            self.area_a.node_layers.START + self.area_a.node_layers.NUMBER
        )
        ...
        self.border_bc.node_layer.INDEX = (
            self.area_b.node_layers.START + self.area_b.node_layers.NUMBER
        )
        ...
        self.area_b.triangles.START = (
            self.area_a.triangles.START + self.area_a.triangles.NUMBER
        )
        self.area_a.triangles.END = self.area_b.triangles.START - 1
        self.area_b.triangles.NUMBER = self.area_a.triangles.NUMBER * 2
        self.area_c.triangles.START = (
            self.area_b.triangles.START + self.area_b.triangles.NUMBER
        )
        ...
        self.area_b.triangle_layers.START = (
            self.area_a.triangle_layers.START + self.area_a.triangle_layers.NUMBER
        )
        ...
        self.area_c.triangle_layers.START = (
            self.area_b.triangle_layers.START + self.area_b.triangle_layers.NUMBER
        )
